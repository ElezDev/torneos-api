...
return [
    ...
    'attributes' => [
        ...
        'kickoff_at' => 'hora de inicio',
        'kickoffAt' => 'hora de inicio',
        'status' => 'estado',
        'format' => 'formato',
        'image' => 'imagen',
        'logo' => 'logo',
        ...
        'player_id' => 'jugador',
        'playerId' => 'jugador',
        'related_player_id' => 'jugador relacionado',
        'relatedPlayerId' => 'jugador relacionado',
        'type' => 'tipo',
        'minute' => 'minuto',
        'shirt_number' => 'número de camiseta',
        'shirtNumber' => 'número de camiseta',
        'tournament_group_id' => 'grupo',
        'tournamentGroupId' => 'grupo',
        'is_owner' => 'dueño',
        'isOwner' => 'dueño',
    ],
    'custom' => [],
